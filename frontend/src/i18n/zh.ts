...
export default {
  ...
  "chainHealth.title": '全链路健康',
  "chainHealth.loading": '正在收集无额度诊断证据…',
  ...
  "chainHealth.details": '明细',
  "chainHealth.recommendations": '建议操作',
  "chainHealth.containers": 'Docker / Compose 容器',
  "chainHealth.privacy": '隐私边界',
  "chainHealth.loadFailed": '链路健康检查失败',
  ...
  "chainHealth.layer.gateway": '网关',
  "chainHealth.layer.runtime": '运行环境',
  "chainHealth.layer.account": "账号 / 配额",
  "chainHealth.attribution": "故障归因",
  "chainHealth.layer.upstream": '账号池 / 上游（被动）',
  "chainHealth.status.ok": '正常',
  "chainHealth.status.degraded": '降级',
  "chainHealth.status.error": '故障',
  "chainHealth.status.unknown": '未知',
  "chainHealth.status.idle": '空闲',
  ...
  "providerForm.autoReviewUi.title": "按模型指定 Auto Review",
  ...
  "codex.docApplyOk": "已保存 {doc}(旧版本已备份到 History)",
  "codex.docBackupOk": "已备份当前 {doc} 到 History",
  "codex.docRestoreConfirm": "确认还原此版本?当前 {doc} 会先备份到 History",
  "codex.docRestoreOk": "已还原 {doc}",
  ...
  "common.reset": "重置",
  "codex.backupConfirm": "为当前内容创建一份备份快照?",
  "common.delete": "删除",
  "common.edit": "编辑",
  "common.copy": "复制",
  "common.saveOnly": "仅保存",
  ...
  "providersAdd.opencodeLogin.label": "OpenCode 账号",
  "providersAdd.opencodeLogin.button": "登录 OpenCode",
  "providersAdd.opencodeLogin.statusLoggedIn": "已登录",
  "providersAdd.opencodeLogin.statusNotLoggedIn": "未登录",
  "providersAdd.opencodeLogin.statusLoggingIn": "登录中…",
  "providersAdd.opencodeLogin.success": "OpenCode 登录成功,已记录账号 session",
  "providersAdd.opencodeLogin.cancelled": "登录未完成(窗口已关),未记录 session",
  "providersAdd.kimiLogin.label": "Kimi 账号",
  "providersAdd.kimiLogin.button": "登录 Kimi",
  "providersAdd.kimiLogin.statusLoggedIn": "已登录",
  "providersAdd.kimiLogin.statusNotLoggedIn": "未登录",
  "providersAdd.kimiLogin.statusLoggingIn": "登录中…",
  "providersAdd.kimiLogin.success": "Kimi 登录成功,已记录账号 session",
  "providersAdd.kimiLogin.cancelled": "登录未完成(窗口已关),未记录 session",
  ...
  "mcp.restorePromptBody":
    "检测到 ~/.codex/.credentials.json 不见了，但本应用备份里有 {count} 条 MCP 授权。请逐条选择恢复 / 移除 / 忽略；未处理项下次启动会再次提示，已忽略项不再自动弹窗但仍可在设置页手动处理。",
  "mcp.restoreDone": "已从备份恢复 {count} 条 MCP 授权",
  "mcp.recovery.restore": "恢复",
  "mcp.recovery.remove": "移除",
  "mcp.recovery.ignore": "忽略",
  "mcp.recovery.selectAll": "全选",
  "mcp.recovery.restoreSelected": "全部恢复",
  "mcp.recovery.removeSelected": "全部删除",
  "mcp.recovery.ignoreAll": "全部忽略",
  "mcp.recovery.ignored": "已忽略",
  "mcp.recovery.removeDone": "已移除 {count} 条 MCP 授权备份",
  "mcp.recovery.ignoreDone": "已忽略 {count} 条",
  "settings.sessionHistoryTitle": "会话历史",
  "settings.sessionHistoryDesc": "管理本地的会话历史",
  "settings.sessionHistoryClear": "清空会话历史",
  "settings.sessionHistoryClearConfirmTitle": "清空会话历史？",
  "settings.sessionHistoryClearConfirm": "将把本地所有 Codex 对话历史移到回收站（可在 Finder 废纸篓恢复），并清空 proxy 续轮缓存。正在进行的对话续轮会中断、需重发。确定继续？",
  "settings.sessionHistoryClearOk": "已清空 {count} 条会话历史（已移到回收站）",
  "settings.sessionHistoryClearPartial": "已清空 {ok} 条，{failed} 条移回收站失败",
  "settings.sessionHistoryClearFailed": "清空会话历史失败",
  "settings.sessionRestoreBtn": "恢复",
  "settings.sessionImportBtn": "导入",
  "settings.sessionClearBtn": "清空",
  "settings.sessionImportTitle": "检测到 {count} 条其他工具的隔离会话",
  "settings.sessionImportMessage": "这些会话来自其他工具（写了第三方 model_provider），需关闭 Codex 才能导入到本工具显示，导入后会自动重启 Codex。",
  "settings.sessionImportConfirmBtn": "关闭 Codex",
  "settings.sessionImportOk": "已导入 {count} 条会话",
  "settings.sessionImportEmpty": "未检测到可导入的隔离会话",
  "settings.sessionImportFailed": "导入失败",
  "settings.sessionRestoreTitle": "恢复会话到其他工具",
  "settings.sessionRestoreMessage": "选择要写回的 model_provider，对应会话将在该工具重新显示。需关闭 Codex 写入，完成后自动重启。",
  "settings.sessionRestoreEmpty": "没有可恢复的会话（需先扫描或导入过才有记录）",
  "settings.sessionRestoreOk": "已恢复 {count} 条会话到 {provider}",
  "settings.sessionRestoreFailed": "恢复失败",
  "settings.sessionImportPartial": "已导入 {ok} 条，{failed} 条失败",
  "settings.sessionRestorePartial": "已恢复 {ok} 条，{failed} 条失败",
  "settings.codexRelaunchFailed": "会话已处理，但 Codex 未能自动重启，请手动打开",
  "settings.mcpRecoveryTitle": "丢失的 MCP 授权",
  "settings.mcpRecoveryHandle": "处理",
  "settings.mcpRecoveryPending": "{count} 条待恢复",
  "settings.mcpRecoveryAllIgnored": "已全部忽略（{count} 条）",
  ...
  "settings.configBackup": "配置文件",
  "settings.exportConfig": "导出配置",
  "settings.importConfig": "导入配置",
  "settings.exportConfigOk": "已导出配置文件",
  "settings.importConfigOk": "已导入配置",
  "settings.configBackupHint": "providers、模型映射、全部设置(含 API Key)",
  ...
  "theme.paletteEdit": "调色盘",
  "theme.paletteTitle": "调色盘定制",
  "theme.paletteReuse": "复用预制调色盘",
  "theme.paletteReusePick": "选一个预制主题…",
  "theme.paletteAccent": "强调色",
  "theme.paletteAccentNative": "跟随 Codex 原生蓝",
  "theme.paletteInk": "文字色",
  "theme.paletteBase": "背景底色",
  "theme.paletteSurface": "面板色",
  "theme.paletteScrim": "蒙版深浅",
  "theme.paletteScrimBase": "跟随基底",
  "theme.paletteReset": "还原默认",
  "theme.paletteSave": "保存",
  "theme.paletteSaved": "调色盘已保存",
  "theme.paletteResetDone": "已还原默认调色盘",
  ...
  "oauth.pasteCodePlaceholder": "粘贴授权页显示的 code",
  "oauth.submitCode": "提交",
  "oauth.submitCodeFailed": "提交 code 失败",
  "oauth.pasteCodeHint": "在弹出的授权页复制显示的 code,粘到此处完成登录",
  ...
  "providerForm.messagesModelsFiltered": "messages 协议模型已过滤",
  "providerForm.showKey": "显示",
  "providerForm.hideKey": "隐藏",
