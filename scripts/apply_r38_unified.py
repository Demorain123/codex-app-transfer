...
# Preserve the complete r37 feature set first, then add the lifecycle-only outer overlay.
...
required = {
    ...
    "frontend/src/i18n/zh.ts": ["Sub2API Grok Compat r38 · v2.4.5+38"],
    "frontend/src/i18n/en.ts": ["Sub2API Grok Compat r38 · v2.4.5+38"],
}
...
print("r38 unified composition: COMPLETE (r37 preserved + deterministic proxy lifecycle hardening)")
