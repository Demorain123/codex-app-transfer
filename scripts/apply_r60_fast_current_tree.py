...
def has_complete_r59_generated_baseline() -> bool:
    paths = (BACKEND, PROCESS, COMPACT, MCP_SERVERS, NO_MICRO, CARGO, FORWARD)
...
if "let after = input.len();" not in forward or "input_items_after: after" not in forward:
    raise SystemExit("r60 fast-current-tree borrow-safety invariant missing")
...
print("- only Sub2API post-compaction native Responses replay compatibility is added")
print("- r59 recovery, r58 lifecycle, r57 migration, r56 compact parser and r49 TEMP remain unchanged")
