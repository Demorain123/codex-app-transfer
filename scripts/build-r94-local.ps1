...
$RuntimeDebugContracts = @(
    ...
    @{ Text = $ThemeInjectorRsText; Marker = '__casR94OutputEventDiagnostics' },
    @{ Text = $ThemeInjectorRsText; Marker = 'rollout-token-interval' },
    @{ Text = $ThemeInjectorRsText; Marker = 'outMeta=' },
    @{ Text = $ThemeInjectorRsText; Marker = 'tpsExact=' },
