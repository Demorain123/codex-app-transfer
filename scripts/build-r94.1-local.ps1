...
foreach ($Check in @(
    ...
    @{ Text = $RetryForwardText; Marker = 'CAS-R94-1-TRANSFER-RETRY-INCIDENT-SCOPE' },
    @{ Text = $RetryForwardText; Marker = 'mark_finite_retry_round_exhausted' },
    ...
    @{ Text = $RetrySettingsText; Marker = 'upstreamConnectRetryMaxMinutes' },
    @{ Text = $RetrySettingsText; Marker = 'retry_duration_to_ms' },
    ...
    @{ Text = $RetrySettingsPageText; Marker = 'upstreamConnectRetryMaxMinutes' },
    @{ Text = $RetrySettingsPageText; Marker = 'onUpstreamConnectRetryDurationPart' },
