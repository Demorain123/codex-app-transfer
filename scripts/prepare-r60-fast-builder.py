...
r60_guard_tail = r59_guard_tail + " -and ((Get-Content -LiteralPath (Join-Path $repoRoot 'src-tauri\\src\\admin\\handlers\\thread_recovery.rs') -Raw -Encoding UTF8) -match 'CAS-R60-RECOVERY-SESSION-CATALOG')"
